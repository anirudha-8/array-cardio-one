...
const oldToYoung = birthYears.sort((a, b) => b - a);
console.log(oldToYoung);

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const megaLifeSpan = inventors
    .map((inventor) => inventor.passed - inventor.year)
    .reduce((acc, span) => acc + span, 0);
console.log(megaLifeSpan);

// 5. Sort the inventors by years lived
const lifeSpanSort = inventors
    .map((inventor) => inventor.passed - inventor.year)
    .sort((a, b) => a - b);
console.log(lifeSpanSort);
